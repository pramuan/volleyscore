...
- **Error Handling**: แสดงหน้า "Match Not Found" เมื่อพยายามเข้าถึงแมตช์ที่ถูกลบไปแล้ว
...
### 0. การเข้าสู่ระบบและความปลอดภัย (Login & Security)

#### การเข้าสู่ระบบ Management Dashboard
- เข้าที่หน้า **Login** (`http://localhost:5173/login`)
- ใส่ Email และ Password ที่สร้างไว้ใน PocketBase
- กดปุ่ม "Sign In" เพื่อเข้าสู่ระบบ
- หากล็อกอินสำเร็จ จะถูกนำไปยังหน้า Management Dashboard

#### การตั้งค่า PIN สำหรับ Controller
- แต่ละแมตช์จะมี **PIN 4 หลัก** สำหรับป้องกันการเข้าถึง Controller
- PIN จะถูกสร้างอัตโนมัติเมื่อสร้างแมตช์ใหม่ (หรือกำหนดเองได้)
- เมื่อเปิดหน้า Controller จะต้องใส่ PIN ทุกครั้ง
- PIN จะแสดงอยู่ที่การ์ดแมตช์ในหน้า Management
- สามารถแก้ไข PIN ได้ในหน้า Edit Match
